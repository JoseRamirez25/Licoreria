...
public class AdaptadorListaVentas extends RecyclerView.Adapter<AdaptadorListaVentas.HolderList> implements View.OnClickListener{

    ArrayList<ListVentas> Lista_datos;
    View.OnClickListener listener;

    public AdaptadorListaVentas(ArrayList<ListVentas> lista_datos) {
